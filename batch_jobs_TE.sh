...
do
    ...
    do
        ...
        do
            jobid="TE_v3_20dim"$cv"cv"$csTE"csTE"$aE"aE"
            ...
            echo 'python -m ae_model_train_v2 --batchsize 200 --cvfold '$cv' --alpha_T 1.0 --alpha_E '$aE' --lambda_TE '$csTE' --latent_dim 3 --n_epochs 1500 --n_steps_per_epoch 500 --ckpt_save_freq 500 --n_finetuning_steps 500 --run_iter 0 --model_id v3 --exp_name TE_20intdim'>>subjob.bash
            echo '...'
            sleep 1
            wait
            qsub subjob.bash
